...
function _getOAuthUrl(client_id, redirect_uri, scope, state) {
  var allow_signup = arguments.length <= 4 || arguments[4] === undefined ? "true" : arguments[4];
...
var GitHubApi = function () {
  ...
  _createClass(GitHubApi, [{
    ...
    value: function updateAccessToken(accessToken) {
      var tokenType = arguments.length <= 1 || arguments[1] === undefined ? "bearer" : arguments[1];
    ...
    value: function onRedirect() {
      ...
      var code = _parseTokenQueryStrin.code;
      var state = _parseTokenQueryStrin.state;
      var scope = _parseTokenQueryStrin.scope;
    ...
    value: function createGist(files, description) {
      var is_public = arguments.length <= 2 || arguments[2] === undefined ? false : arguments[2];
